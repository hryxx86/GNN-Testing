...
NEWS_PATH = Path("data/pilot/news_clean.csv")
PRICE_PATH = Path("data/reference/sp500_5y_prices.csv")
OUT_PARQUET = Path("data/pilot/news_events.parquet")
OUT_CSV = Path("data/pilot/news_events.csv")
