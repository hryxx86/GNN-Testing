...
_INPUT (primary): `experiments/storya_v21_main12_c5` — device mps (devices seen ['mps'], 1 invocation(s)), platform macOS-26.3.1-arm64-arm-64bit, results.csv md5 1d7445bf5081ea3683d0a5d1c9e0b562, git_rev 9008dbe956220951db54975af8516365de9061d2, source_clean True, post-hoc code identity None; family-dir stats from the same results.csv: True; analysis mode {'n_boot': 5000, 'strict': True, 'smoke': False, 'out_dir': 'artifacts/storya_v21_family1_c5_mac'}._
...
|---|---|---|---|---|---|---|---|---|
| C5 | +0.0880 | 55% | +0.0064 | [-0.0041, +0.0184] | 0.185 | 0.291 | 0.0162 | 687 |
...
_(L1-L0)_C - (L1-L0)_C5: CI includes 0; paired MDE 0.0243 > |C contrast| 0.0148 → the interval does NOT exclude a halving or a doubling of the contrast; equivalence is not established (underpowered non-rejection)._

_(L1-L0)_B - (L1-L0)_C5: CI includes 0; paired MDE 0.0278 > |C contrast| 0.0148 → the interval does NOT exclude a halving or a doubling of the contrast; equivalence is not established (underpowered non-rejection)._
